...
const Offer = () => {
    return (
        <div className='space-y-3'>
            ...
            <div className='flex gap-4  lg:px-24 xl:px-44 overflow-x-scroll hidden-scrollbar scroll-smooth'>
                <div className='px-3 py-3 rounded-md border'>
                    <div className='w-[530px] lg:w-full grid grid-cols-7 gap-3 '>
                ...
                <div className=''>
                    <div className='w-[577px] h-[178px] rounded-md overflow-hidden relative flex'>
            ...
            <div>
                <div className='flex justify-center'><div className='w-2 h-2 rounded-full bg-blue-600' /></div>
            </div>
        </div>
    )
}
